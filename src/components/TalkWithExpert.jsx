function TalkWithExpert() {
  return (
    <div className=" p-2 flex flex-col  bg-[#f2f1f9] rounded-2xl mt-[32px] overflow-hidden">
        ...
        <div className="text-center gap-4 p-6 flex flex-col items-center justify-center">
          <h2 className="text-[#7551b3] font-bold text-2xl mb-2">
            Talk With Expert
          </h2>

          <p className="text-gray-700 text-base leading-relaxed mb-4 px-2">
            Engage in genuine, confident discussions with experts, fostering
            trust, sharing insights, and encouraging collaborative
            problem-solving.
          </p>

          <button className="bg-black rounded-lg text-white py-3 px-6 text-lg font-medium mb-6 hover:bg-gray-800 transition-colors">
            Ask a question
          </button>
