export default function WhyChooseDoctar() {
  return (
    <div>
        <h2 className="text-center text-black text-xl mt-2 mb-2 ">why choose DOCTAR ?</h2>
        <div className="flex text-[10px] gap-2.5 rounded-xl mb-20 ">
          <div className="flex-col w-[200px] flex rounded-xl overflow-hidden bg-white h-[225px] flex-1 shadow-[0px_4px_5px_5px_rgba(0,0,0,0.25)]">
          ...
          <div className="flex-col w-[200px] rounded-xl overflow-hidden bg-white h-[225px] flex flex-1 shadow-[0px_4px_5px_5px_rgba(0,0,0,0.25)]">
