        ...
        <div className="space-y-3">
          ...
          {(doctor?.contactPhones?.length > 0 ? doctor.contactPhones.slice(0, 2) : ['+91 68753 4234']).map((phone, index) => (
            ...
            >
              ...
              <span className="text-lg font-bold text-black hover:text-[#7551B2] transition-colors" style={{fontWeight: 700}}>
                {phone}
              </span>
            </div>
          ))}
          ...
          >
            ...
            <span className="text-lg font-bold text-black hover:text-[#25D366] transition-colors" style={{fontWeight: 700}}>
              {doctor?.contactPhones?.[0] || '+91 68753 4234'}
            </span>
          </div>
...
[Your Name]`;
          ...
          >
            ...
            <span className="text-lg font-bold text-black hover:text-[#EA4335] transition-colors" style={{fontWeight: 700}}>
